...
$rs = $sql->query(
"SELECT t.id As ID, t.ano_letivo As Ano, t.semestre AS Semestre, t.disciplina_id As IDdisciplina
FROM turmas t
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1>Turmas atendidas pelo professor</h1>
            ...
            <table class="table">
                ...
                <?php foreach($rs as $ln): ?>
                    <tr>
                        ...
                        <td><?php echo $ln["IDdisciplina"];?></td>
                    </tr>
                <?php endforeach ?>
            </table>
