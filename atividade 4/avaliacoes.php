...
<html>
    ...
    <body>
        ...
        <div class="container">
            <table class="table">
                <tr>
                    <tr><h1>Avaliações</h1></tr>
                    <tr><a href="addavaliacoes.php" class="btn">Adicionar nova avaliação</a></tr>
                </tr>
            </table>
            ...
            <table class="table">
                ...
                <?php foreach($rs as $ln): ?>
                    <tr>
                        ...
                        <td>
                            <a href="detalharavaliacoes.php?id=<?php echo $ln['ID'];?>" class="btn">Detalhar</a>
