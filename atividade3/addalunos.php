...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header("Location: adicionar_alunos.php");
    exit();
    }
    ...
    <body>
        ...
        <div class="container">
            <table class="table">
                <tr>
                    <td><h1>Alunos</h1></td>
                    <td><a href="../adicionar.php" class="btn btn-dark">Voltar</a></td>
                </tr>
            </table>
            ...
            <table class="table table-dark table-striped">
                ...
                <?php endforeach ?>
                <form action="adicionar_alunos.php" method="POST">
                    <tr>
                        ...
                        <td><input type="number" name="curso" style="width:100%"></td>
                    </tr>
                    </table>
